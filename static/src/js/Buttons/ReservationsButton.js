odoo.define('pos_quotation_order.ReservationsButton', function (require) {
    'use strict';
    ...
    class ReservationsButton extends PosComponent {
        // constructor() {
        //     super(...arguments);
    ...
    ReservationsButton.template = 'ReservationsButton';

    Registries.Component.add(ReservationsButton);
