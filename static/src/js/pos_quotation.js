odoo.define('point_of_sale.pos_quotation_order', function (require) {
    ...
    //         var order_time = this.$('.order_time').val();
    //         var order_note = this.$('.order_note').val();
    //         var retiro = this.$('#retiro').prop('checked');
    //         if (retiro == true) {
    //             var retiro = true
    //         }
    //         else {
    //             var retiro = false
    //         };
    //         var artesanal = this.$('#artesanal').prop('checked');
    //         if (artesanal == true) {
    //             var artesanal = true
    //         }
    //         else {
    //             var artesanal = false
    //         };
    //         var entrega = this.$('#entrega').prop('checked');
    //         if (entrega == true) {
    //             var entrega = true
    //         }
    //         else {
    //             var entrega = false
    //         };
    //         var recibe = this.$('#recibe').val();
    //         var dir_entrega = this.$('#dir_entrega').val();
    //         var tel_entrega = this.$('#tel_entrega').val();
    //         var valid_date = true;
